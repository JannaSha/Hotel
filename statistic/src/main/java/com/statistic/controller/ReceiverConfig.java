...
public class ReceiverConfig {
    ...
    @Bean
    public ConsumerFactory<String, OrderKafka> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs());
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderKafka>> kafkaListenerContainerFactory() {
